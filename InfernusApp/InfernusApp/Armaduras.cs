...
namespace InfernusApp
{
    public partial class Armaduras : Form
    {
        ...
        private void InicializaDropDown()
        {
            ...
            DataTable dtTipoArmadura = new DataTable();
            ...
            foreach (DataTable dt in dts.Tables)
            {
                ...
                else if (dt.TableName == "tb_tipo_armadura")
                {
                    dtTipoArmadura = dt;
                }
            ...
            //
            cbxTipoArmad.DataSource = dtTipoArmadura;
            cbxTipoArmad.DisplayMember = "nome";
            cbxTipoArmad.ValueMember = "id_tipo_armadura";
        }
        ...
        private void btnEnviar_Click(object sender, EventArgs e)
        {
            ...
            obj.tipoArmadura = cbxTipoArmad.SelectedValue.ToString();
            obj.forca = txtForca.Text.ToString();
            obj.furtv = txtFurtv.Text.ToString();
            ...
            string retorno = _service.adicionaItenRPG(_item.montaDtsArmadura(obj));
